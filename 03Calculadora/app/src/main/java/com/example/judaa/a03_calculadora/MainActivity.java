package com.example.judaa.a03_calculadora;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pattern = "00";
        format = new DecimalFormat("#0."+ pattern );
    }
    ...
    private void getView(){
        ...
        this.more = this.findViewById( R.id.more );
        this.less = this.findViewById( R.id.less );
        this.module = this.findViewById( R.id.module );
    }
    ...
    private void setEvents() {
        ...
        this.module.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                executeFunction(FUN_MOD);
            }
        });
        this.more.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                pattern +="0";
                format = new DecimalFormat("#0."+ pattern );
                Toast.makeText(getApplicationContext(), "Formato actualizado a " + pattern.length() +" decimales", Toast.LENGTH_SHORT).show();
            }
        });
        this.less.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                if(pattern.length() > 0){
